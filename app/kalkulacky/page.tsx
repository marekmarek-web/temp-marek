...
export const metadata: Metadata = {
  title: "Kalkulačky",
  description: "Hypotéka, investice, životní pojištění, penze – orientační výpočty.",
};
      ...
      <div className="max-w-content mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link
            ...
            className="block bg-white rounded-2xl border border-brand-border p-8 shadow-sm hover:shadow-md transition-shadow"
          >
